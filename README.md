# Домашнее задание к занятию «Система мониторинга Zabbix. Часть 2» - Андрей Аксенов
...
Скриншот созданного шаблона и его Item'ов:

![zadanie1](img/zadanie1/01_01.png)
...
Скриншот привязки шаблона к хостам:
![hosts_templates](img/zadanie2/02_01.png)
...
Скриншот Latest Data с поступающими данными по двум шаблонам и созданным кастомным параметрам:
![latestdata](img/zadanie3/03_01.png)
...
![zadanie4](img/zadanie4/04_01.png)
